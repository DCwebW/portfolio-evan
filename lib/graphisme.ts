...
export const GRAPHISME_IMAGES: ImageInfo[] = [
  {
    src: '/Graphisme/FallyIpupaProjet.jpeg',
  ...
  {
    src: '/Graphisme/FeliciaProjet.jpeg',
  ...
  {
    src: '/Graphisme/FeliciaProjet2.png',
    title: 'Félicia - Communication artistique',
    description:
      "Création d'un support visuel destiné à accompagner la communication artistique et médiatique de Félicia.",
  },
  {
    src: '/Graphisme/FreddyConduiteProjet.jpeg',
  ...
  {
    src: '/Graphisme/FreddyConduiteProjet2.jpeg',
    title: 'Freddy Conduite',
    description:
  ...
  {
    src: '/Graphisme/LaFouineProjet.jpeg',
  ...
  {
    src: '/Graphisme/LilDurkProjet.jpeg',
  ...
  {
    src: '/Graphisme/PierreFeretAffiche.png',
    title: 'Pierre Feret - Affiche',
    description: "Affiche publicitaire réalisée pour l'atelier de joaillerie Pierre Feret (Fontainebleau). Un design élégant et haut de gamme valorisant le savoir-faire artisanal et les services de l'atelier",
  },
  {
    src: '/Graphisme/PierreFeretAffiche-2.png',
    title: 'Pierre Feret - Affiche 2',
    description: "Affiche publicitaire réalisée pour l'atelier de joaillerie Pierre Feret (Fontainebleau). Un design élégant et haut de gamme valorisant le savoir-faire artisanal et les services de l'atelier",
  },
  {
    src: '/Graphisme/S-PriNoirProjet.jpeg',
    title: 'S-Pri Noir - La clé du château',
    description:
  ...
  {
    src: '/Graphisme/TiakolaProjet.jpeg',
    title: 'Tiakola',
    description:
